...
class TestDSTFunctions:
    ...
    def test_is_dst_switchover_spring(self):
        ...
        spring_switch = datetime(2026, 3, 29)  # Last Sunday in March
...
class TestDataValidator:
    ...
    def test_count_slots_per_day_single_day(self):
        ...
        values = [
            ApiValue(timestamp=f"202608131{str(i).zfill(2)}00", value=0.5, status="VALID", date="2026-08-13", tariff="TOTAL")
    ...
    def test_count_slots_per_day_multiple_days(self):
        ...
        values = [
            ApiValue(timestamp="20260813120000", value=0.5, status="VALID", date="2026-08-13", tariff="TOTAL"),
            ApiValue(timestamp="20260813130000", value=0.5, status="VALID", date="2026-08-13", tariff="TOTAL"),
            ApiValue(timestamp="20260814120000", value=0.5, status="VALID", date="2026-08-14", tariff="TOTAL"),
        ]
    ...
    def test_get_latest_complete_date(self):
        ...
        values = [
            ...
            ApiValue(timestamp="20260814120000", value=0.25, status="VALID", date="2026-08-14", tariff="TOTAL"),
        ]
