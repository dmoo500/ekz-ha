...
class TestStatisticsTransformer:
    ...
    def test_values_to_statistics_single_value(self):
        ...
        values = [
            ApiValue(timestamp="20260813120000", value=1.5, status="VALID", date="2026-08-13", tariff="TOTAL"),
        ]
    ...
    def test_values_to_statistics_running_sum(self):
        ...
        values = [
            ApiValue(timestamp="20260813120000", value=1.0, status="VALID", date="2026-08-13", tariff="TOTAL"),
            ApiValue(timestamp="20260813130000", value=2.0, status="VALID", date="2026-08-13", tariff="TOTAL"),
            ApiValue(timestamp="20260813140000", value=1.5, status="VALID", date="2026-08-13", tariff="TOTAL"),
        ]
    ...
    def test_values_to_statistics_with_zero_offset(self):
        ...
        values = [
            ApiValue(timestamp="20260813120000", value=5.0, status="VALID", date="2026-08-13", tariff="TOTAL"),
        ]
